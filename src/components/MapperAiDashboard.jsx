      ...
      <div className="flex-1 overflow-hidden">
        <header className="bg-white border-b sticky top-0 z-10">
          <div className="flex justify-between items-center px-6 py-3">
            ...
            <button className="px-3 py-1.5 hover:bg-gray-100 rounded-lg">Overview</button>
          </div>
        </header>
  
        <main className="p-6 flex h-[calc(100vh-64px)]">
          {/* Main Content */}
          <div className="w-2/3 pr-6 border-r border-gray-300 overflow-hidden">
            <div className="bg-white p-8 rounded-lg shadow text-center mb-6" style={{ height: '500px' }}>
              ...
              <p className="text-gray-600 mb-4">Designed to simplify, scan, and <br />streamline your asset data management.</p>
              ...
              <button className="bg-black text-white px-4 py-2 rounded-full">Added</button>
            </div>
            {/* Input Field */}
          ...
          {/* Right Side: Overview */}
          <div className="w-1/3 space-y-6 pl-6 overflow-y-auto">
            ...
            <div className="bg-gray-100 p-4 rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-2 gap-4">
                {tasks.map((task, index) => (
                  <div
                    key={index}
                    className="bg-gray-200 text-gray-800 text-sm font-medium py-2 px-4 rounded-lg text-center shadow-sm hover:bg-gray-200 transition cursor-pointer"
                  >
                    {task.name}
                  </div>
                ))}
